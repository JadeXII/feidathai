<div class="col-12">
    <div class="container">
        <h1 class="text-center pt-5">มะเร็งกับการรักษา</h1>
        <div class="col-12">
            <div class="row">
                <?php foreach ($query->result()  As $row):?>
                <div class=" col-sm-4">
                    <div class="card mb-4 shadow-sm">
                        <a href="<?echo base_url('/Cancer_articles/detail/');?>/<?echo $row->id;?>"><img class="card-img-top" src="http://localhost/newfeidathai/assetes/knowledgeicon/<?php echo $row->post_date;?>.jpg"></a>
                        <div class="card-body">
