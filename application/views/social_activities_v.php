<div class="col-12">
    <div class="container">
        <h4 class="text-center pt-4 font-weight-bold">กิจกรรมเพื่อสังคม</h4>
        <div class="col-12 pt-4">
            <div class="row">
                <?php foreach ($query->result()  As $row):?>
                <div class=" col-sm-4">
                    <div class="card mb-4 shadow-sm">
                        <a href="#<?php echo $row->id;?>"><img class="card-img-top" src="http://localhost/newfeidathai/assetes/knowledgeicon/<?php echo $row->post_date;?>.jpg"></a>
                        <div class="card-body">
